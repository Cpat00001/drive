...
echo ' 
 <nav class="navbar navbar-expand-md bg-dark navbar-dark">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link" href="naukajazdy_kategoriaC.php">Kategoria C</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="naukajazdy_kategoriaCE.php">Kategoria C+E</a>
      </li>
      ...
      <li class="nav-item">
        <a class="nav-link" href="szkolenia_przewozy_rzeczy_osob.php"> Przewóz rzeczy i osób</a>
      </li>
    </ul>
