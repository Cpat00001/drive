...
<head>
 ...
 <meta name="keywords" content="prawo jazdy na motor Świdnica, kategoria A świdnica , kat A Świdnica, nauka jazdy na motory, Świdnica, szkola jazdy na motory, nauka jazdy na motocykle świdnica, nauka jazdy motorem dzierżoniów , nauka jazdy motorem bielawa, nauka jazdy motorem strzegom, cena prawo jazdy na motor, kursy motocyklowe Świdnica, Dzierżoniów, Bielawa , prawo jazdy na motor
 Dzierżoniów Strzegom Bielawa , kategoria A Dzierżoniów Bielawa Strzegom.">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
...
<h4>Motocykl lżejszy i niższy, idealny dla kobiet.</h4>
<p>Marka: Yamaha <br>
   Model : MT-07 <br>
   Pojemność : 698cm3 <br>
   Skrzynia biegów: 6 stopni <br>
   Przeniesienie napędu : łańcuch <br>
   Hamulec: Tarczowy ABS <br>
   Moc: 74,8 KM <br>
   Rozruch : elektryczny <br>
   Masa : 179kg <br>
</p>
<div class="alert alert-danger" role="alert">
  Yamaha XJ6 ABS 600cm3 jak egzaminacyjna WORD Wałbrzych i Wroclaw
</div>
<p>
Marka: Yamaha <br>
Model: XJ6 ABS <br>
Pojemność silnika: 600 cm3 <br>
Skrzynia biegów: 6 stopni <br>
Przeniesienie napędu: łańcuch <br>
Hamulec: Tarczowy ABS <br>
Moc: 77,49 KM <br>
...
<div class="container-fluid">
  <div class="row">
    <div class="col-md-6" id="warunki">
        <h4>Motocykle kategorii A: naked, enduro, sport, classic, cruiser , chopper.</h4>
      <img src="../images/motocykl_kategoriaA.png" alt="prawo jazdy kategorii A swidnica strzegom dzierzoniow bielawa"
    ...
    <div class="col-md-6" id="warunki">
      ...
      <ul>
        ...
        <li>
          <p>1 fotografia: kolorowa, aktualna , 3.5 x 4.5cm, dobrej jakości, pokazująca wyraźnie oczy / źrenice</p>
        </li>
        <li>
