...
?>
<!--Second header for current site navigation-->
<nav class="navbar navbar-expand-md bg-secondary navbar-dark" id="menu">
  <ul class="navbar-nav">
    ...
    <li class="navbar-nav">
      <a class="nav-link" href="#warunki">Warunki formalne</a>
    </li>
    <li class="nav-item">
 ...
 <!--kontakt-->
     <div class="row">
      <div class="col-md-4" id="kontakt">
        <h3>Wybieram kurs nauki jazdy AM motorowery w Wiraż Świdnica</h3><br>
...
<!--optional JavaScript,JQuery,popper.js-->
